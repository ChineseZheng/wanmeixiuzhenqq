...
null == window.HTMLVideoElement && (window.HTMLVideoElement = HTMLDivElement), function(e) {
    ...
    !function(i) {
        ...
        i.XMLText = s, e(s.prototype, "egret.wxgame.XMLText"), r.XML = {
            parse: function(e) {
                o || (window.DOMParser ? o = new DOMParser() : console.error("没有 XML 支持库，请访问 http://developer.egret.com/cn/github/egret-docs/Engine2D/minigame/minigameFAQ/index.html#xml 了解详情"));
